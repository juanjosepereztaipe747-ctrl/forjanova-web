  ...
  return (
    <div style={styles.bg}>
      ...
      <div style={styles.navbar}>
        ...
        <button style={{ ...styles.navBtn, ...styles.navBtnActive }} onClick={() => onChangeView('crear')}>
          + Crear
        </button>
      </div>
        ...
        <div style={styles.form}>
          ...
          <div style={styles.field}>
            ...
            <input
              style={styles.input}
              type="text"
              placeholder="Ej: Huancayo, Jr. Lima 123"
          ...
          <div style={styles.btnRow}>
            <button style={styles.cancelBtn} onClick={() => onChangeView('home')}>
              Cancelar
            </button>
            <button
...
const styles = {
  ...
  cancelBtn: {
    background: 'transparent', border: '1px solid #333', color: '#666',
    borderRadius: '8px', padding: '12px 24px', fontSize: '14px', cursor: 'pointer',
  },
  submitBtn: {
